    ...
    <div className="signup-page">
      <div className="signup-shell">
        <section className="signup-left-panel">
          ...
          <p>Safe, anonymous, and confidential. Your identity is protected every step of the way.</p>
          <div className="signup-trust-row">
            <span><FaLock className="trust-icon" /> End-to-end encrypted</span>
            <span><FaUserSecret className="trust-icon" /> Anonymous profile</span>
        ...
        <div className="signup-header">
          ...
          <p className="signup-subtitle">Join SafeTalk to connect with university therapists.</p>
        </div>
        ...
        <form onSubmit={handleEmailSignUp} className="signup-form">
          ...
          {error && (
            <div className="error-message error-message-block">
              {error}
            </div>
          )}
