-- Standalone schema file (same as supabase/migrations/20260328120000_account_deletion_requests.sql).
-- Apply via Supabase SQL editor or `supabase db push` if you use CLI migrations.
